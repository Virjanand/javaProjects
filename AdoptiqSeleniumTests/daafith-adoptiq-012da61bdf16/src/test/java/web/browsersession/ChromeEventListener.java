...
public class ChromeEventListener implements WebDriverEventListener {
	...
	public void beforeFindBy(By arg0, WebElement arg1, WebDriver arg2) {
		try {
			Thread.sleep(400);
		} catch (InterruptedException e) { //one way to solve chrome issues
			LOG.log(Level.SEVERE, "Wait interrupted", e.getSuppressed());
		}
	}
