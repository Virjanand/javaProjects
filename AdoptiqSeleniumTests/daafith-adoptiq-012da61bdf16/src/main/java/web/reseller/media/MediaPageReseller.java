...
import web.Page;
import web.reseller.media.tabs.MediumTab;
import web.reseller.media.tabs.NieuwMediumTab;

public class MediaPageReseller extends Page {
	...
	public MediaPageReseller(WebDriver driver) {
		super(driver);
	}
